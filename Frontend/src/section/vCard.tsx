...
const vCard = () => {
  return (
    <div className="flex flex-col justify-center items-center pt-48 pb-15 px-4">
      ...
      <div className="w-full p-4 md:p-8 bg-[#F7F7F7] rounded-b-lg z-1">
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-3'>
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">vCard</h2>
          <p className="text-gray-600 text-sm md:text-md lg:text-lg">Digitize your networking. Share contact information instantly — phone, email, and address — saved directly into the user’s contacts with one scan.</p>
