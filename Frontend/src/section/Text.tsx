...
const Text = () => {
  return (
    <div className="w-full min-h-[85vh] bg-[linear-gradient(45deg,theme(colors.blue.400),theme(colors.blue.100),white)] flex justify-center items-center gap-8 py-8 md:py-16 lg:py-24 px-4 md:px-12 lg:px-20">

      <div className="flex flex-col justify-center gap-4 text-center md:text-left px-4">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900">Text</h2>
