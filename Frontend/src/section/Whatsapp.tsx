import website from '../assets/hero/Whatsapp.png'
...
const Whatsapp = () => {
  ...
  const handleCreateQrCode = () => {
    dispatch(activeTab('whatsapp'))
    navigate('/new-qr');
  }

  return (
    <div className="flex flex-col justify-center items-center pt-48 px-4">
      <div className='w-full h-[40vh] lg:h-[50vh] bg-gradient-to-b from-purple-500 to-white rounded-t-lg flex justify-center'>
      ...
      <div className="w-full p-4 md:p-8 bg-[#F7F7F7] rounded-b-lg z-1">
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-3'>
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">WhatsApp</h2>
          <p className="text-gray-600 text-sm md:text-md lg:text-lg">Enable instant chats with pre-filled messages. Let customers reach your WhatsApp in one scan, improving communication, support, and engagement.</p>
