    ...
    <div className="flex flex-col justify-center items-center pt-48 pb-16 px-4">
      ...
      <div className="w-full p-4 md:p-8 md:pl-24 bg-[#F7F7F7] rounded-b-lg z-1">
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-3'>
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">vCard Plus</h2>
          <p className="text-gray-600 text-sm md:text-md lg:text-lg">Transform your contact sharing into a digital experience. The vCard Plus QR lets you showcase your profile, company details, and social media links in a stylish interactive template — one scan to connect.</p>
