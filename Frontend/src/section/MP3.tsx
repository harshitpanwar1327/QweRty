...
const MP3 = () => {
  return (
    <div className="w-full min-h-[80vh] bg-gradient-to-l from-teal-600 via-teal-100 to-white flex justify-center items-center px-6 md:px-15 lg:px-28">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 max-w-7xl">
        ...
        <div className="flex flex-col justify-center max-w-md md:max-w-2xl lg:max-w-3xl text-center md:text-left mx-auto px-4">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">MP3</h2>
