...
const Image = () => {
  return (
    <div className="flex flex-col justify-center items-center pt-48 px-4">
      <div className='w-full h-[40vh] lg:h-[50vh] bg-gradient-to-b from-red-500 to-white rounded-t-lg flex justify-center'>
      ...
      <div className="w-full p-4 md:p-8 md:pl-24 bg-[#F7F7F7] rounded-b-lg z-1">
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-3'>
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">Image</h2>
          <p className="text-gray-600 text-sm md:text-md lg:text-lg">Deliver images instantly. Whether product catalogs, event posters, or infographics, scanning reveals your image in the user’s browser without extra steps.</p>
