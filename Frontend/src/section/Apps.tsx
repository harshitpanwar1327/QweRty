...
const Apps = () => {
  return (
    <div className="flex flex-col justify-center items-center pt-48 px-4">
      <div className='w-full h-[40vh] lg:h-[50vh] bg-gradient-to-b from-orange-300 to-white rounded-t-lg flex justify-center'>
      ...
      <div className="w-full p-4 md:p-8 bg-[#F7F7F7] rounded-b-lg z-1">
        <div className='w-full md:w-2/3 flex flex-col justify-center gap-3'>
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900">Apps</h2>
          <p className="text-gray-600 text-sm md:text-md lg:text-lg">Drive app downloads directly. Users scanning the code are redirected to the right App Store or Play Store page for quick installation.</p>
