    ...
    <div className='flex flex-col lg:flex-row items-center justify-around p-3 w-full'>
      ...
      <div className='flex flex-col justify-center gap-4 text-black w-full lg:w-1/3 p-8 lg:p-16'>
        ...
        <form className = "flex flex-col justify-center gap-4" onSubmit={handleSubmit}>
          ...
          <button className = "font-semibold bg-pink-600 text-white py-2 rounded-full hover:scale-102 transition duration-300">Send email</button>
          <button className = "font-semibold border border-gray-300 bg-white text-pink-600 py-2 rounded-full hover:scale-102 transition duration-300">Cancel</button>
        </form>
